...
//       <main className="relative z-10 mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-6xl flex-col px-4 py-6">
//         {children}
//       </main>
//     </div>
//   );
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              <span className="bg-gradient-to-r from-sky-300 via-indigo-300 to-fuchsia-300 bg-clip-text text-[11px] font-semibold uppercase tracking-[0.45em] text-transparent">
                FinalSibCTF2025
              </span>
